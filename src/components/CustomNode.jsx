    ...
    >
      ...
      <div style={{ padding: '6px 12px 4px' }}>
        <button
          ...
          style={{ background: 'none', border: 'none', cursor: 'pointer', fontSize: 10, color: data.notes ? '#a1a1aa' : '#3f3f46', padding: 0, display: 'flex', alignItems: 'center', gap: 4 }}
        >
        ...
        {notesOpen && (
          <div
            style={{ marginTop: 6, color: '#71717a', fontSize: 10.5, lineHeight: 1.55, whiteSpace: 'pre-wrap', wordBreak: 'break-word', cursor: 'text' }}
            onDoubleClick={e => { e.stopPropagation(); data.onEdit?.(); }}
          >
      ...
      {/* Footer: estado + prioridad + timestamp */}
      <div style={{ padding: '4px 12px 8px', display: 'flex', alignItems: 'center', gap: 6 }}>
        ...
        {data.updatedAt && (
          <span style={{ marginLeft: 'auto', fontSize: 9, color: '#27272a' }}>
