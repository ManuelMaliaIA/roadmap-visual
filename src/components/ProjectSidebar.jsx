...
export default function ProjectSidebar({ projects, activeId, onSelect, onCreate, onDelete }) {
  ...
  if (collapsed) {
    return (
      <div style={{
        width: 36, background: '#0c0c0e', borderRight: '1px solid #1c1c1f',
        display: 'flex', flexDirection: 'column', alignItems: 'center',
        padding: '10px 0', gap: 8, flexShrink: 0,
      }}>
        <button
          onClick={() => setCollapsed(false)}
          title="Expandir proyectos"
          style={iconBtn}
        >›</button>
        {projects.map(p => (
          <div
            ...
            style={{
              ...
              background: p.id === activeId ? '#7c3aed' : '#27272a',
  ...
  return (
    <aside style={{
      width: 210, background: '#0c0c0e', borderRight: '1px solid #1c1c1f',
      ...
      <div style={{
        ...
        <span style={{ fontSize: 10, color: '#3f3f46', fontWeight: 700, letterSpacing: '0.1em', textTransform: 'uppercase', flex: 1 }}>
          Proyectos
        </span>
        ...
        {projects.map(p => (
          <div
            ...
            style={{
              ...
              padding: '8px 12px',
              background: p.id === activeId ? '#18181b' : 'transparent',
              borderLeft: `2px solid ${p.id === activeId ? '#7c3aed' : 'transparent'}`,
              cursor: 'pointer',
          ...
          >
            <span style={{
              ...
              color: p.id === activeId ? '#fafafa' : '#71717a',
            ...
            {projects.length > 1 && (
              <button
                ...
                style={{ background: 'none', border: 'none', color: '#3f3f46', cursor: 'pointer', fontSize: 14, padding: '0 2px', lineHeight: 1, flexShrink: 0 }}
      ...
      <div style={{ padding: '8px 10px 12px', borderTop: '1px solid #1c1c1f', flexShrink: 0 }}>
        {adding ? (
          <div style={{ display: 'flex', gap: 6 }}>
            <input
              ...
              style={{
                ...
                borderRadius: 6, padding: '6px 8px', color: '#fafafa',
          ...
          <button
            ...
            style={{
              width: '100%', background: 'none', border: '1px dashed #27272a',
              borderRadius: 6, padding: '7px 0', color: '#3f3f46', cursor: 'pointer',
              fontSize: 12, transition: 'color 0.12s, border-color 0.12s',
            }}
