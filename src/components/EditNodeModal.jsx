...
export default function EditNodeModal({ node, onClose, onSave }) {
  ...
  return (
    <div style={{
      ...
      >
        <h3 style={{ margin: '0 0 22px', color: '#fafafa', fontSize: 15, fontWeight: 700 }}>
          Editar nodo
        </h3>
        ...
        <input
          ...
          placeholder="Subtítulo visible en la tarjeta"
          style={inp}
        />
        ...
        <textarea
          ...
          placeholder="Apuntes, recordatorios, detalles…"
...
const lbl = { display: 'block', color: '#52525b', fontSize: 11, marginBottom: 5, marginTop: 16, fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.06em' };
